...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    # Write and read
    backend.write("test/file.bin", b"hello world")
    assert backend.read("test/file.bin") == b"hello world"
    assert backend.exists("test/file.bin")

    # Delete
    backend.delete("test/file.bin")
    assert not backend.exists("test/file.bin")
