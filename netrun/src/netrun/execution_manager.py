...
__all__ = ['ExecutionManager', 'ExecutionManagerProtocolKeys', 'JobResult', 'PoolType', 'RunAllocationMethod', 'SubmittedJobInfo', 'remote_execution_manager_worker']
...
def remote_execution_manager_worker(channel, worker_id: int, print_flush_interval: float = 0.1, capture_prints: bool = True) -> None:
    ...
    Example:
        ...
        from .execution_manager import remote_execution_manager_worker
...
# %% nbs/netrun/04_execution_manager.ipynb 18
@dataclass
class JobResult:
...
# %% nbs/netrun/04_execution_manager.ipynb 19
