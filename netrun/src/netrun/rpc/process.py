# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/netrun/02_rpc/03_process.ipynb

__all__ = ['ProcessChannel', 'SyncProcessChannel', 'create_queue_pair']

# %% nbs/netrun/02_rpc/03_process.ipynb 3
import asyncio
...
# %% nbs/netrun/02_rpc/03_process.ipynb 7
...
# %% nbs/netrun/02_rpc/03_process.ipynb 9
