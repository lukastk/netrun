# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/netrun/02_rpc/03_remote.ipynb

__all__ = ['ConnectionHandler', 'WebSocketChannel', 'connect', 'connect_channel', 'serve', 'serve_background']

# %% nbs/netrun/02_rpc/03_remote.ipynb 3
import asyncio
import pickle
import json
...
# %% nbs/netrun/02_rpc/03_remote.ipynb 5
...
# %% nbs/netrun/02_rpc/03_remote.ipynb 7
@asynccontextmanager
...
# %% nbs/netrun/02_rpc/03_remote.ipynb 8
...
# %% nbs/netrun/02_rpc/03_remote.ipynb 12
@asynccontextmanager
