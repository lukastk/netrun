# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/netrun/02_rpc/02_thread.ipynb

__all__ = ['SyncThreadChannel', 'ThreadChannel', 'create_thread_channel_pair']

# %% nbs/netrun/02_rpc/02_thread.ipynb 3
import asyncio
import queue
import threading
...
# %% nbs/netrun/02_rpc/02_thread.ipynb 7
class ThreadChannel:
...
# %% nbs/netrun/02_rpc/02_thread.ipynb 9
