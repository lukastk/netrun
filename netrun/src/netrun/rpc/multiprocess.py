# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/03_rpc/03_multiprocess.pct.py

__all__ = ['ProcessChannel', 'SyncProcessChannel', 'create_queue_pair']

# %% pts/netrun/03_rpc/03_multiprocess.pct.py 3
import asyncio
...
# %% pts/netrun/03_rpc/03_multiprocess.pct.py 5
...
# %% pts/netrun/03_rpc/03_multiprocess.pct.py 7
...
# %% pts/netrun/03_rpc/03_multiprocess.pct.py 9
