# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/03_pool/04_aio.pct.py

__all__ = ['AsyncWorkerFn', 'SingleWorkerPool']

# %% pts/netrun/03_pool/04_aio.pct.py 3
import asyncio
...
# %% pts/netrun/03_pool/04_aio.pct.py 5
...
# %% pts/netrun/03_pool/04_aio.pct.py 7
