# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/03_pool/00_base.pct.py
...
# %% pts/netrun/03_pool/00_base.pct.py 3
...
# %% pts/netrun/03_pool/00_base.pct.py 5
WorkerId = int
"""Unique identifier for a worker within a pool."""

# %% pts/netrun/03_pool/00_base.pct.py 6
...
# %% pts/netrun/03_pool/00_base.pct.py 7
@dataclass
class WorkerMessage:
...
# %% pts/netrun/03_pool/00_base.pct.py 9
@runtime_checkable
class Pool(Protocol):
...
# %% pts/netrun/03_pool/00_base.pct.py 15
...
# %% pts/netrun/03_pool/00_base.pct.py 16
...
# %% pts/netrun/03_pool/00_base.pct.py 17
