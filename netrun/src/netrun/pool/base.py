# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/04_pool/00_base.pct.py

__all__ = ['BasePool', 'POOL_UP_ERROR_CRASHED', 'POOL_UP_ERROR_EXCEPTION', 'POOL_UP_ERROR_KEYS', 'POOL_UP_ERROR_TIMEOUT', 'Pool', 'PoolAlreadyStarted', 'PoolError', 'PoolNotStarted', 'WorkerCrashed', 'WorkerError', 'WorkerException', 'WorkerFn', 'WorkerId', 'WorkerMessage', 'WorkerTimeout']

# %% pts/netrun/04_pool/00_base.pct.py 3
...
# %% pts/netrun/04_pool/00_base.pct.py 5
WorkerId = int
"""Unique identifier for a worker within a pool."""

# %% pts/netrun/04_pool/00_base.pct.py 6
...
# %% pts/netrun/04_pool/00_base.pct.py 7
@dataclass
class WorkerMessage:
...
# %% pts/netrun/04_pool/00_base.pct.py 9
@runtime_checkable
class Pool(Protocol):
...
# %% pts/netrun/04_pool/00_base.pct.py 15
...
# %% pts/netrun/04_pool/00_base.pct.py 16
...
# %% pts/netrun/04_pool/00_base.pct.py 17
...
# %% pts/netrun/04_pool/00_base.pct.py 25
import asyncio
import time
import logging
