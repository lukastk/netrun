...
__all__ = ['MP_DOWN_BROADCAST', 'MP_DOWN_DISPATCH', 'MP_DOWN_FLUSH_STDOUT', 'MP_DOWN_SHUTDOWN', 'MP_UP_RESPONSE', 'MP_UP_SHUTDOWN_COMPLETE', 'MP_UP_STDOUT_BUFFER', 'MultiprocessPool', 'OutputBuffer']
...
# %% nbs/netrun/03_pool/02_multiprocess.ipynb 14
...
# %% nbs/netrun/03_pool/02_multiprocess.ipynb 16
