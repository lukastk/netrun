# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/netrun/05_net/01_net/01_info.ipynb

__all__ = ['EdgeInfo', 'NodeInfo']

# %% nbs/netrun/05_net/01_net/01_info.ipynb 3
...
# %% nbs/netrun/05_net/01_net/01_info.ipynb 4
class NodeInfo:
