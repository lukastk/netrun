# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/05_net/01_net/01_info.pct.py

__all__ = ['EdgeInfo', 'NodeInfo']

# %% pts/netrun/05_net/01_net/01_info.pct.py 3
...
# %% pts/netrun/05_net/01_net/01_info.pct.py 4
class NodeInfo:
