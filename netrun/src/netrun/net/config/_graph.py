# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/05_net/00_config/02_graph.pct.py

__all__ = ['GraphConfig', 'GraphNodeConfig']

# %% pts/netrun/05_net/00_config/02_graph.pct.py 2
...
# %% pts/netrun/05_net/00_config/02_graph.pct.py 4
