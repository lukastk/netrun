...
__all__ = ['DeferredActionQueue', 'EdgeInfo', 'EpochCancelled', 'Net', 'NetFuncPreprocessor', 'NetFuncPreprocessorNodeConfig', 'NetProtocolKeys', 'NodeExecutionContext', 'NodeExecutionResult', 'NodeFailureContext', 'NodeInfo', 'OutputPacket', 'PacketTypeMismatch', 'create_net_func_done_callback', 'create_net_func_preprocessor']
...
from ..net.config import NetConfig, NodeExecutionConfig, NodeVariable, OutputQueueConfig, PortConfig, PortTypeConfig
...
class NodeInfo:
    ...
    def cfg(self) -> "NodeConfig":
        ...
        """
        from ..net.config import NodeConfig
...
# %% nbs/netrun/05_net/01_net.ipynb 21
class Net:
