# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/09_cli/02_commands.pct.py

__all__ = ['ConfigOpt', 'PrettyOpt', 'convert', 'factory_info', 'info', 'node', 'nodes', 'structure', 'validate']

# %% pts/netrun/09_cli/02_commands.pct.py 2
import importlib
import inspect
import json
import sys
...
# %% pts/netrun/09_cli/02_commands.pct.py 5
...
# %% pts/netrun/09_cli/02_commands.pct.py 7
...
# %% pts/netrun/09_cli/02_commands.pct.py 9
def convert(
...
# %% pts/netrun/09_cli/02_commands.pct.py 11
def factory_info(
...
# %% pts/netrun/09_cli/02_commands.pct.py 15
def nodes(
    config: ConfigOpt = None,
    pretty: PrettyOpt = False,
) -> None:
...
# %% pts/netrun/09_cli/02_commands.pct.py 17
def node(
