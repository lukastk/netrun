# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/netrun/05_deferred.ipynb

__all__ = ['DeferredAction', 'DeferredActionQueue', 'DeferredActionType', 'DeferredPacket']

# %% nbs/netrun/05_deferred.ipynb 3
...
from .errors import DeferredPacketIdAccessError
...
# %% nbs/netrun/05_deferred.ipynb 4
