# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun/01_storage.pct.py

__all__ = ['LazyPacketValueEvaluationError', 'LazyPacketValueSpec', 'PacketStore']

# %% pts/netrun/01_storage.pct.py 2
...
# %% pts/netrun/01_storage.pct.py 4
...
# %% pts/netrun/01_storage.pct.py 6
@dataclass
...
# %% pts/netrun/01_storage.pct.py 8
class PacketStore:
