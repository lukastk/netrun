# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/netrun/10_port_types.ipynb

__all__ = ['PortTypeRegistry', 'PortTypeSpec', 'check_value_type']

# %% nbs/netrun/10_port_types.ipynb 3
...
# %% nbs/netrun/10_port_types.ipynb 4
