# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/examples/08_dsl_format.ipynb

__all__ = ['consumed_packet_storage', 'create_pipeline_graph', 'exec_node_func', 'from', 'history_max_size', 'in_ports', 'max_salvos', 'on_error', 'options', 'out_ports', 'ports', 'run_export_to_toml', 'run_expression_parser', 'run_load_from_toml', 'run_save_and_load_file', 'run_toml_format_overview', 'to', 'when']

# %% nbs/examples/08_dsl_format.ipynb 2
import tempfile
...
# %% nbs/examples/08_dsl_format.ipynb 3
...
# %% nbs/examples/08_dsl_format.ipynb 4
...
# %% nbs/examples/08_dsl_format.ipynb 5
...
# %% nbs/examples/08_dsl_format.ipynb 6
...
# %% nbs/examples/08_dsl_format.ipynb 7
...
# %% nbs/examples/08_dsl_format.ipynb 8
