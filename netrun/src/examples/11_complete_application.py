# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/examples/11_complete_application.ipynb

__all__ = ['ETL_PIPELINE_TOML', 'ErrorRecord', 'RawRecord', 'TransformedRecord', 'ValidatedRecord', 'checkpoint_dir', 'config', 'defer_net_actions', 'definition_path', 'elapsed', 'entries', 'error_handler_exec', 'extractor_exec', 'from', 'history', 'history_file', 'in_ports', 'loader_exec', 'max_salvos', 'metrics', 'net', 'on_error', 'out_ports', 'pool', 'ports', 'rate_limit_per_second', 'retries', 'size', 'start_time', 'temp_dir', 'to', 'transformer_exec', 'validator_exec', 'when']

# %% nbs/examples/11_complete_application.ipynb 2
import tempfile
import time
...
# %% nbs/examples/11_complete_application.ipynb 4
ETL_PIPELINE_TOML = '''
[net]
on_error = "continue"
...
# %% nbs/examples/11_complete_application.ipynb 6
@dataclass
class RawRecord:
...
# %% nbs/examples/11_complete_application.ipynb 8
...
# %% nbs/examples/11_complete_application.ipynb 10
...
# %% nbs/examples/11_complete_application.ipynb 12
...
# %% nbs/examples/11_complete_application.ipynb 14
...
# %% nbs/examples/11_complete_application.ipynb 16
...
# %% nbs/examples/11_complete_application.ipynb 18
...
# %% nbs/examples/11_complete_application.ipynb 20
print("\n" + "="*60)
...
# %% nbs/examples/11_complete_application.ipynb 22
print("\n--- Pipeline Metrics ---")
...
# %% nbs/examples/11_complete_application.ipynb 24
...
# %% nbs/examples/11_complete_application.ipynb 26
print("\n--- Event History ---")
...
# %% nbs/examples/11_complete_application.ipynb 28
