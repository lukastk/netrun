# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/03_rpc/test_base.pct.py

__all__ = ['test_channel_closed_exception', 'test_channel_closed_is_exception', 'test_recv_timeout_exception', 'test_recv_timeout_is_exception', 'test_shutdown_key_follows_convention', 'test_shutdown_key_is_string']

# %% pts/tests/03_rpc/test_base.pct.py 2
import pytest
