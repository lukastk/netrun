# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/02_rpc/test_thread.pct.py
...
# %% pts/tests/02_rpc/test_thread.pct.py 2
import pytest
import asyncio
import threading
import time
...
# %% pts/tests/02_rpc/test_thread.pct.py 4
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 6
...
# %% pts/tests/02_rpc/test_thread.pct.py 9
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 11
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 13
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 16
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 19
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 21
...
# %% pts/tests/02_rpc/test_thread.pct.py 23
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 26
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 28
...
# %% pts/tests/02_rpc/test_thread.pct.py 31
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 33
def test_sync_close():
...
# %% pts/tests/02_rpc/test_thread.pct.py 35
@pytest.mark.asyncio
...
# %% pts/tests/02_rpc/test_thread.pct.py 37
...
# %% pts/tests/02_rpc/test_thread.pct.py 40
@pytest.mark.asyncio
