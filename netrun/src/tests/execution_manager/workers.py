# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/05_execution_manager/workers.pct.py

__all__ = ['add_numbers', 'async_add', 'async_subprocess_function', 'function_returns_non_serializable', 'function_with_error', 'function_with_kwargs', 'function_with_multiple_prints', 'function_with_print', 'function_with_unpicklable_error', 'mp_stdout_function', 'multiply_numbers', 'nested_async_function', 'slow_function', 'slow_printing_function']

# %% pts/tests/05_execution_manager/workers.pct.py 2
import asyncio
import sys
import time
