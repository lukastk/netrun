# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/05_execution_manager/test_execution_manager_remote.pct.py

__all__ = ['create_remote_client', 'create_remote_execution_manager', 'pytestmark', 'test_execution_manager_remote_context_manager', 'test_execution_manager_remote_kwargs', 'test_execution_manager_remote_multiple_workers', 'test_execution_manager_remote_timestamps', 'test_execution_manager_with_remote_pool', 'test_remote_pool_concurrent_runs', 'test_remote_pool_creation', 'test_remote_pool_function_with_kwargs', 'test_remote_pool_multiple_workers', 'test_remote_pool_run_function', 'test_remote_pool_send_function']

# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 2
import pytest
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 3
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 5
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 7
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 9
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 11
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 13
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 15
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 17
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 20
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 22
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 24
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 26
@pytest.mark.asyncio
...
# %% pts/tests/05_execution_manager/test_execution_manager_remote.pct.py 28
@pytest.mark.asyncio
