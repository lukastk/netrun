...
__all__ = ['add_numbers', 'async_add', 'function_returns_non_serializable', 'function_with_error', 'function_with_kwargs', 'function_with_print', 'mp_stdout_function', 'multiply_numbers', 'slow_function', 'test_flush_all_pool_stdout', 'test_flush_all_pool_stdout_raises_for_non_multiprocess', 'test_flush_pool_stdout', 'test_flush_pool_stdout_raises_for_non_multiprocess', 'test_get_process_ids', 'test_get_process_ids_raises_for_non_multiprocess']
...
# %% nbs/tests/04_execution_manager/test_execution_manager_multiprocess.ipynb 7
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_multiprocess.ipynb 9
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_multiprocess.ipynb 11
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_multiprocess.ipynb 17
@pytest.mark.asyncio
