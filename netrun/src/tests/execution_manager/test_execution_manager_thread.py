# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb

__all__ = ['add_numbers', 'async_add', 'function_returns_non_serializable', 'function_with_error', 'function_with_kwargs', 'function_with_multiple_prints', 'function_with_print', 'mp_stdout_function', 'multiply_numbers', 'slow_function', 'slow_printing_function', 'test_allocation_with_specific_workers', 'test_async_function', 'test_concurrent_jobs', 'test_context_manager', 'test_create_execution_manager', 'test_create_multiple_pools', 'test_double_start_raises', 'test_empty_workers_raises', 'test_flush_all_pool_stdout', 'test_flush_all_pool_stdout_raises_for_non_multiprocess', 'test_flush_pool_stdout', 'test_flush_pool_stdout_raises_for_non_multiprocess', 'test_function_with_kwargs', 'test_get_num_workers', 'test_get_process_ids', 'test_get_process_ids_raises_for_non_multiprocess', 'test_get_worker_jobs_empty', 'test_immediate_close', 'test_invalid_pool_type', 'test_job_result_timestamps', 'test_main_pool', 'test_multiple_pools', 'test_non_serializable_result_for_main_process', 'test_on_print_callback', 'test_pool_ids', 'test_print_buffer_in_result', 'test_print_buffer_multiple_prints', 'test_random_allocation', 'test_round_robin_allocation', 'test_send_function_and_run', 'test_send_function_to_pool', 'test_start_and_close']

# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 2
import pytest
import asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 4
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 6
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 8
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 10
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 13
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 15
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 17
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 19
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 22
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 24
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 27
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 29
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 32
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 34
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 37
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 40
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 42
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 44
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 46
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 49
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 52
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 55
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 58
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 61
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 64
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 66
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 67
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 69
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 70
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 73
import sys
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 74
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 76
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 78
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 80
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 82
@pytest.mark.asyncio
...
# %% nbs/tests/04_execution_manager/test_execution_manager_thread.ipynb 84
@pytest.mark.asyncio
