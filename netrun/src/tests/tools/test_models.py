# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/09_tools/test_models.pct.py
...
# %% pts/tests/09_tools/test_models.pct.py 2
import pytest
...
# %% pts/tests/09_tools/test_models.pct.py 3
