# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/09_tools/test_execute.pct.py
...
# %% pts/tests/09_tools/test_execute.pct.py 2
import pytest
...
# %% pts/tests/09_tools/test_execute.pct.py 3
@pytest.mark.asyncio
