# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/09_tools/test_template.pct.py

__all__ = ['test_build_template_variables_custom_env', 'test_build_template_variables_empty', 'test_build_template_variables_node_config_default', 'test_build_template_variables_precedence', 'test_build_template_variables_with_values', 'test_resolve_project_root_absolute', 'test_resolve_project_root_none', 'test_resolve_project_root_none_with_net_file', 'test_resolve_project_root_relative', 'test_resolve_template_brace_syntax', 'test_resolve_template_custom_vars', 'test_resolve_template_dollar_syntax', 'test_resolve_template_multiple', 'test_resolve_template_no_match', 'test_resolve_template_node_config', 'test_resolve_template_regex_safe_value', 'test_resolve_template_single_quotes_brace_syntax', 'test_resolve_template_single_quotes_mixed', 'test_resolve_template_single_quotes_preserved', 'test_resolve_working_directory_explicit', 'test_resolve_working_directory_net_file', 'test_resolve_working_directory_none', 'test_resolve_working_directory_project_root']

# %% pts/tests/09_tools/test_template.pct.py 2
import pytest
...
# %% pts/tests/09_tools/test_template.pct.py 3
# --- resolve_project_root ---
