# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/02_storage/test_retrieval.pct.py

__all__ = ['test_create_backend_from_json_local', 'test_retrieve_from_bundle_tar_gz', 'test_retrieve_from_bundle_zip', 'test_retrieve_value_json', 'test_retrieve_value_pickle', 'test_retrieve_value_with_gzip_compression', 'test_retrieve_value_with_zlib_compression']

# %% pts/tests/02_storage/test_retrieval.pct.py 2
import json
import tempfile
import pytest
...
# %% pts/tests/02_storage/test_retrieval.pct.py 4
...
# %% pts/tests/02_storage/test_retrieval.pct.py 6
...
# %% pts/tests/02_storage/test_retrieval.pct.py 8
