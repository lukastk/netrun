# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/07_node_factories/test_from_function.pct.py

__all__ = ['test_from_function_with_types', 'test_from_function_without_types', 'test_generic_type_stored_as_type_object_not_string', 'test_generic_type_survives_from_function_roundtrip', 'test_get_node_config_with_types', 'test_get_node_config_without_types', 'test_get_node_funcs_accepts_include_port_types', 'test_include_port_types_with_generic_types', 'test_manual_output_get_node_config', 'test_manual_output_get_node_funcs', 'test_manual_output_returns_none', 'test_parse_function_signature_with_types', 'test_parse_function_signature_without_types', 'test_parse_return_annotation_preserves_non_packet_ports', 'test_port_config_accepts_generic_types', 'test_port_config_rejects_invalid_types', 'test_precreated_packet_multi_port', 'test_precreated_packet_no_type', 'test_precreated_packet_single_port', 'test_precreated_packet_with_port_config', 'test_single_output_dict_return_unwrapped', 'test_single_output_plain_return_unchanged']

# %% pts/tests/07_node_factories/test_from_function.pct.py 2
import pytest
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 4
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 5
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 6
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 7
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 8
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 9
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 10
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 11
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 12
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 13
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 14
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 15
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 17
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 18
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 19
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 20
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 21
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 23
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 24
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 25
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 27
import asyncio
...
# %% pts/tests/07_node_factories/test_from_function.pct.py 29
