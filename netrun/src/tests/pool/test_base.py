# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/04_pool/test_base.pct.py
...
# %% pts/tests/04_pool/test_base.pct.py 2
import pytest
...
# %% pts/tests/04_pool/test_base.pct.py 8
...
# %% pts/tests/04_pool/test_base.pct.py 11
def test_pool_error():
    """Test PoolError exception."""
    with pytest.raises(PoolError):
        raise PoolError("Test error")

# %% pts/tests/04_pool/test_base.pct.py 13
...
# %% pts/tests/04_pool/test_base.pct.py 15
...
# %% pts/tests/04_pool/test_base.pct.py 17
...
# %% pts/tests/04_pool/test_base.pct.py 20
