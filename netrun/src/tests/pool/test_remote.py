# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/04_pool/test_remote.pct.py

__all__ = ['pytestmark', 'test_broadcast', 'test_client_creation', 'test_compute_workers', 'test_connect_and_create_pool', 'test_flush_all_stdout', 'test_flush_stdout_clears_buffer', 'test_flush_stdout_single_process', 'test_invalid_worker_id', 'test_multiple_workers', 'test_recv_timeout', 'test_register_worker', 'test_send_before_create_raises', 'test_send_recv', 'test_server_creation', 'test_stdout_before_create', 'test_stdout_content', 'test_stdout_invalid_process_idx', 'test_stdout_redirect_default', 'test_stdout_stderr_distinction', 'test_try_recv_empty', 'test_try_recv_with_message', 'test_unknown_worker_raises']

# %% pts/tests/04_pool/test_remote.pct.py 2
import pytest
import asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 3
...
# %% pts/tests/04_pool/test_remote.pct.py 5
from ..pool.workers import echo_worker, compute_worker, printing_worker

# %% pts/tests/04_pool/test_remote.pct.py 7
def test_server_creation():
    """Test creating a RemotePoolServer."""
    server = RemotePoolServer()
    assert server.registered_workers == []

# %% pts/tests/04_pool/test_remote.pct.py 9
...
# %% pts/tests/04_pool/test_remote.pct.py 12
...
# %% pts/tests/04_pool/test_remote.pct.py 15
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 17
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 19
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 22
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 24
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 27
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 30
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 33
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 35
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 37
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 40
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 43
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 45
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 47
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 49
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 51
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 53
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 55
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_remote.pct.py 57
@pytest.mark.asyncio
