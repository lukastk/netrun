# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/04_pool/test_exceptions_remote.pct.py
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 2
import pytest
import time
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 4
from ..pool.workers import echo_worker, compute_worker, raising_worker

# %% pts/tests/04_pool/test_exceptions_remote.pct.py 7
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 9
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 11
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 13
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 16
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 19
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 21
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 24
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 27
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 29
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 32
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 35
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 37
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 40
@pytest.mark.asyncio
...
# %% pts/tests/04_pool/test_exceptions_remote.pct.py 43
