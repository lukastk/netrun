# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/06_net/test_signals.pct.py

__all__ = ['test_default_signals_applied_to_all_nodes', 'test_epoch_cancelled_signal_max_epochs', 'test_epoch_cancelled_signal_user_cancel', 'test_epoch_failed_signal_triggers_downstream', 'test_epoch_finished_signal_triggers_downstream', 'test_epoch_started_signal_triggers_downstream', 'test_generate_signal_ports', 'test_generate_signal_salvo_conditions', 'test_is_signal_port', 'test_net_config_default_signals_validation', 'test_no_signal_ports_by_default', 'test_node_closed_signal', 'test_node_execution_config_signals_validation', 'test_node_initialized_signal', 'test_node_initialized_signal_deferred_startup', 'test_per_node_signal_override', 'test_signal_no_output_queue_for_signal_ports', 'test_signal_port_name', 'test_signal_ports_auto_generated_on_resolve', 'test_signal_ports_inherited_from_net_config', 'test_signal_ports_opt_out_with_empty_list', 'test_signal_type_from_port', 'test_signal_unconnected_port_no_crash', 'test_signal_value_dataclass', 'test_signal_with_regular_output', 'test_validate_signal_types_invalid', 'test_validate_signal_types_valid']

# %% pts/tests/06_net/test_signals.pct.py 2
import pytest
import asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 4
...
# %% pts/tests/06_net/test_signals.pct.py 5
...
# %% pts/tests/06_net/test_signals.pct.py 6
...
# %% pts/tests/06_net/test_signals.pct.py 7
...
# %% pts/tests/06_net/test_signals.pct.py 8
...
# %% pts/tests/06_net/test_signals.pct.py 9
...
# %% pts/tests/06_net/test_signals.pct.py 10
...
# %% pts/tests/06_net/test_signals.pct.py 11
...
# %% pts/tests/06_net/test_signals.pct.py 13
...
# %% pts/tests/06_net/test_signals.pct.py 14
...
# %% pts/tests/06_net/test_signals.pct.py 16
...
# %% pts/tests/06_net/test_signals.pct.py 17
...
# %% pts/tests/06_net/test_signals.pct.py 18
...
# %% pts/tests/06_net/test_signals.pct.py 19
...
# %% pts/tests/06_net/test_signals.pct.py 21
from netrun.net.config import (
...
# %% pts/tests/06_net/test_signals.pct.py 22
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 23
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 24
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 25
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 26
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 27
...
# %% pts/tests/06_net/test_signals.pct.py 28
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 29
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 30
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 31
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 33
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 34
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_signals.pct.py 35
@pytest.mark.asyncio
