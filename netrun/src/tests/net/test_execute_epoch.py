# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/06_net/test_execute_epoch.pct.py

__all__ = ['test_execute_epoch_exists', 'test_execute_epoch_no_exec_func', 'test_execute_epoch_returns_result', 'test_execute_epoch_with_exec_func']

# %% pts/tests/06_net/test_execute_epoch.pct.py 2
import pytest
...
# %% pts/tests/06_net/test_execute_epoch.pct.py 3
...
# %% pts/tests/06_net/test_execute_epoch.pct.py 4
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_execute_epoch.pct.py 5
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_execute_epoch.pct.py 6
@pytest.mark.asyncio
...
# %% pts/tests/06_net/test_execute_epoch.pct.py 7
@pytest.mark.asyncio
