# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/06_net/sample_factory.pct.py

__all__ = ['get_node_config', 'get_node_funcs']

# %% pts/tests/06_net/sample_factory.pct.py 2
...
# %% pts/tests/06_net/sample_factory.pct.py 3
...
# %% pts/tests/06_net/sample_factory.pct.py 4
