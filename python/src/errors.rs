...
create_exception!(netrun_core, NetrunError, PyException);

// Exception hierarchy matching NetActionError variants
create_exception!(netrun_core, PacketNotFoundError, NetrunError);
create_exception!(netrun_core, EpochNotFoundError, NetrunError);
create_exception!(netrun_core, EpochNotRunningError, NetrunError);
create_exception!(netrun_core, EpochNotStartableError, NetrunError);
create_exception!(netrun_core, CannotFinishNonEmptyEpochError, NetrunError);
create_exception!(netrun_core, PacketNotInNodeError, NetrunError);
...
create_exception!(netrun_core, InputPortNotFoundError, NetrunError);
create_exception!(netrun_core, InputPortFullError, NetrunError);
create_exception!(netrun_core, CannotMovePacketFromRunningEpochError, NetrunError);
create_exception!(netrun_core, CannotMovePacketIntoRunningEpochError, NetrunError);
create_exception!(netrun_core, EdgeNotFoundError, NetrunError);
create_exception!(netrun_core, UnconnectedOutputPortError, NetrunError);
create_exception!(netrun_core, GraphValidationError, NetrunError);
...
pub fn net_action_error_to_py_err(err: netrun_core::net::NetActionError) -> PyErr {
    use netrun_core::net::NetActionError;
    match err {
