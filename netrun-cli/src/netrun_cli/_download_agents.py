# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun_cli/05_download_agents.pct.py

__all__ = ['download_agents']

# %% pts/netrun_cli/05_download_agents.pct.py 2
import json
...
# %% pts/netrun_cli/05_download_agents.pct.py 4
_REPO_OWNER = "lukastk"
_REPO_NAME = "netrun"
