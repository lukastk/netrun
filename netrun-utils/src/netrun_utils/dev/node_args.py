# AUTOGENERATED! DO NOT EDIT! File to edit: pts/netrun_utils/01_dev/01_node_args.pct.py

__all__ = ['set_node_func_args']

# %% pts/netrun_utils/01_dev/01_node_args.pct.py 2
import builtins
import sys
...
# %% pts/netrun_utils/01_dev/01_node_args.pct.py 3
