"""6. Bundle Mode (tar.gz)

Store all outputs in a single tar.gz archive per node.
"""
...
async def main():
    print("=" * 60)
    print("6. BUNDLE MODE (tar.gz)")
    print("=" * 60)
    print()
    print("Store all outputs in a single tar.gz archive per node.")
    print()
